...
class CLIPDataset(Dataset):
    def __init__(self, moldataset, specdataset):
        self.moldataset = moldataset
        self.specdataset = specdataset
        assert len(moldataset) == len(specdataset), "Datasets must be of the same length"
        
    def __len__(self):
        return len(self.moldataset)
    
    def __getitem__(self, idx):
        mol_data = self.moldataset[idx]
        spec_data = self.specdataset[idx]
        
        return {'mol_data':mol_data, 'spec_data':spec_data}
