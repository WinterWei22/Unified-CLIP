...
from ms_pred.mabnet import egt_pretrain_model as mol_encoder
...
def train_model():
    ...
    data_dir = 'data/pretrain_datasets'
    labels = f'{data_dir}/{kwargs["dataset_labels"]}'
    ...
    train_dataset = mol_pretrain_data.PretrainDataset(
        train_df,
        data_dir=data_dir,
    ...
    val_dataset = mol_pretrain_data.PretrainDataset(
        val_df,
        data_dir=data_dir,
        magma_map=name_to_json,
        num_workers=num_workers,
    ...
    # Define model
    model = mol_encoder.Pretrain_EGT(
