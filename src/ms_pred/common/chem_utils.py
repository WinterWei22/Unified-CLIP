...
# msg
# VALID_ELEMENTS=['As', 'B', 'Br', 'C', 'Cl', 'F', 'I', 'N', 'O', 'P', 'S', 'Se', 'Si']
VALID_ELEMENTS=['As', 'B', 'Br', 'C', 'Cl', 'F', 'H', 'I', 'N', 'O', 'P', 'S', 'Se', 'Si', 'Na', 'K', 'Co', 'Fe', 'Pt', 'Ir']
...
#                 'Be', 
#                 'Bi', 
#                 'Br', 'C', 'Ca', 'Cl', 'Cs', 'F', 'Ga', 'H', 'He', 'I', 'K', 'Kr', 'Li', 'Mg', 'N', 'Na', 'O', 'P', 'Ra', 'Rb', 'S', 'Se', 'Si', 'Sr', 'Te', 'Xe', 'Zn']
...
# msg
NORM_VEC_MASS = np.array(
    [2, 2, 5, 61, 7, 35, 105, 5,  14, 31, 7, 7, 3, 6, 1, 1, 1, 1, 1, 1, 999]
)
# NORM_VEC_MASS = np.array(
#     [81, 19, 6, 34, 6, 6, 6, 158, 10, 17, 3, 1, 2, 1, 1, 2, 1, 1, 1471]
# )
# msg
NORM_VEC = np.array([2, 2, 5, 61, 7, 35, 105, 5,  14, 31, 7, 7, 3, 6, 1, 1, 1, 1, 1, 1])
...
# canopus
CANOPUS_INSTRUMENTATION_ELEMENTS = {
    'Unknown (LCMS)',
    'Q-ToF (LCMS)',
    'Ion Trap (LCMS)',
    'Bruker Q-ToF (LCMS)',
...
CANOPUS_INSTRUMENTATION_ONEHOT = {
    'Unknown (LCMS)': 0,
    'Q-ToF (LCMS)': 1,
    'Ion Trap (LCMS)': 2,
    'Bruker Q-ToF (LCMS)': 3,
...
# msg
msg_INSTRUMENTATION_ELEMENTS = {
    'Unknown',
    'Orbitrap',
    'QTOF',
}
msg_INSTRUMENTATION_ONEHOT = {
    'Unknown': 0,
    'Orbitrap': 1,
    'Q-ToF': 2,
}
