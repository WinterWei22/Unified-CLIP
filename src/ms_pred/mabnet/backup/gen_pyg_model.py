...
class FragEGT(pl.LightningModule):
    ...
    def forward(
        ...
        Args:
            ...
            ind_maps (_type_): _description_,   (n_frags,)
    ...
    def _common_step(self, batch, name="train"):
        pred_leaving = self.forward(
            ...
            instruments=batch["instrumentations"] if self.instrumentation else None,
