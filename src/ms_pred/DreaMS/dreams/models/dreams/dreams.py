...
from ms_pred.DreaMS.dreams.models.layers.fourier_features import FourierFeatures
...
from ms_pred.DreaMS.dreams.definitions import NIST20, MONA
from ms_pred.DreaMS.dreams.models.optimization.schedulers import NoamScheduler
from ms_pred.DreaMS.dreams.models.dreams.layers import TransformerEncoder
from ms_pred.DreaMS.dreams.models.optimization.losses_metrics import FocalLoss
...
class DreaMS(pl.LightningModule):
    ...
    def __normalize_spec(self, spec):
        ...
        """
        # print(f'spec.device: {spec.device}')
